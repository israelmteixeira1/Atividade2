...
public class Main {
	...
	public static void main(String[] args) {
		...
		ContaEspecial ceLuiz = new ContaEspecial(luiz, 1, 1000.0, Categoria.PREMIUM, 500.0);
		ContaPoupanca cpMaria = new ContaPoupanca(maria, 2, 500.0, Categoria.PERSONALITE, 0.02);
		ContaEspecial ceApple = new ContaEspecial(apple, 3, 100000.0, Categoria.SIMPLES, 10000.0);
		ContaPoupanca cpPadaria = new ContaPoupanca(padaria, 4, 1500.0,Categoria.EXECUTIVA, 0.03);
